      ...
      <div className="grid gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            {isIngredient ? (
              <>
                Стартовое количество ингредиентов у поставщиков (кг/л). Пусто
                или 0 — остатка нет. Задаётся один раз, далее правится
                склад-движениями. Завод — внешний безлимитный источник, стартовый
                остаток для него не задаётся.
              </>
            ) : (
              <>
