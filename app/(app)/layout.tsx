...
export default async function AppLayout({
  ...
  // отрабатывает на каждом переходе. audit-w5b: без правил дефицита к балансам не идём
  // вовсе — запрос ровно один, сами правила (до правки listAlertRules тянул ещё три
  // справочника имён, т.е. 4). С правилами — Σ движений агрегирует БД (groupBy) и только
  // по тем позициям, на которые есть порог. Кэш-слой сознательно не вводим.
