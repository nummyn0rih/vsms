...
- [ ] **Печать всей ленты отгрузок** — сейчас печатается только выбранная неделя. Нужен выбор: текущая неделя (как сейчас) ИЛИ вся лента как на экране (раскрытые недели + активные фильтры) — многостраничный лист.
- [ ] **Кнопка «развернуть все недели»** в ленте (парная к печати всей ленты).
- [ ] **Фильтры в приёмке** (на готовом общем `FilterCombo`).
