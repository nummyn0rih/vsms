...
версия v1** (responsive): шелл+лента ✓ (`552a3fc`) → **приёмка (текущий)** → контакты водителей. Далее F/V2:
...
- [~] mobile-2: приёмка на мобиле (зоны-сегмент, инлайн-вес, полноэкранный акт + acceptance auto-date) — ТЕКУЩИЙ. `PROMPTS-MOBILE-2-ACCEPTANCE.md`.
- [ ] mobile-3: контакты водителей на мобиле (карточки + tel:). `PROMPTS-MOBILE-3-DRIVERS.md`.
