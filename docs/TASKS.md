...
версия v1** (responsive) — ЗАКРЫТА (шелл+лента · приёмка · водители). **Следующий блок — не выбран:** F/V2
печатные формы (PDF) · сравнение сезонов (после истории, этап G) · бэклог V1.1-фильтров. Промпты — `docs/prompts/PROMPTS-*.md`.
