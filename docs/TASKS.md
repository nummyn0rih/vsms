...
V1.1 ЗАКРЫТ. Идёт **этап F/V2**: аналитический дашборд (Recharts) ✓ — **Recharts введён**. **Следующий срез
F/V2 — не выбран:** факт. средний вес рейса · печатные формы (PDF) · сравнение сезонов (после импорта истории,
этап G). Бэклог V1.1: фильтры дашбордов/справочников (FilterCombo готов), PDF акта, мобильная. Промпты — `docs/prompts/PROMPTS-*.md`.
...
- [~] Фактический средний вес рейса (уточняет «осталось ~N машин») — ТЕКУЩИЙ. Спека `PROMPTS-TRIPWEIGHT.md`.
