...
версия v1** (responsive) — ЗАКРЫТА. **Мобильный v2** (Сводка + План, read-only) — ЗАКРЫТ. **Следующий блок —
не выбран:** печатные формы (PDF) · сравнение сезонов (после истории, этап G) · бэклог V1.1-фильтров.
Промпты — `docs/prompts/PROMPTS-*.md`.
...
- [ ] Печатные формы (PDF: акт приёмки / контракт).
