...
- [~] **Палитра цветов проекта** для выбора при создании культуры (вместо произвольного hex) — ТЕКУЩИЙ. Дизайн-спека `DESIGN-CULTURE-PALETTE.md`.
- [ ] **Экспорт в Excel** (SheetJS — в стеке, ещё не использован).
