...
- [~] **Фильтры в приёмке** (на готовом общем `FilterCombo`) — ТЕКУЩИЙ. `PROMPTS-ACCEPTANCE-FILTERS.md`.
- [ ] **Палитра цветов проекта** для выбора при создании культуры (вместо произвольного hex).
